...
public class GroovyDeserializerTest {
    ...
    static final class CfgInjected {
    ...
    private static <T> T deserializeGroovy(String source, Class<T> cls) {
        return new GroovyDeserializer().deserialize(source, cls);
    }

    private static <T> T ok(String source, Class<T> cls) {
        return deserializeGroovy(source, cls);
    }
    ...
    class OptionalSemantics {
        ...
        @Test
        void optionalComplex_providedNull_setsOptionalToEmpty() {
        ...
        @Test
        void providedNullOptional_setsOptionalToEmpty_evenWhenDefaultPresent() {
            CfgOptionalLeafWithDefaultPresent cfg = ok(
                "return [name: null]",
                CfgOptionalLeafWithDefaultPresent.class
            );
